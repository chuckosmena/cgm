...
void printVoucherBak(String code, String productName, String paidAt) {
...
void printVoucher(String code, String productName, String paidAt) {
  ...
  // Printer.println(text, isStyle, size, alignment, isBold, type)

  Printer.setFontStyle('S', 'C', 1, 0);
  Printer.printlnr("5GXMART TECHNOLOGIES CORP.");
  Printer.printlnr("Vat Reg: 646-091-737-00000", true, 'S', 'C', 2);
  Printer.println("________________________________");
  Printer.printlnr(productName, true, 'M', 'C', 1, 2);
  Printer.printlnr("Voucher Code", true, 'M', 'C', 0, 2);
  Printer.printlnr(code, true, 'L', 'C', 1, 2);
  Printer.println("________________________________");

  Printer.setFontStyle('S', 'L', 0, 2);
  Printer.printlnr(
  ...
  Printer.printlnr("Powered by CoolGeeks", true, 'S', 'C', 1, 1);
  Printer.println("================================\n\n");
  Printer.feed(2);
  Printer.sleep();
